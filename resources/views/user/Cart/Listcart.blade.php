                        ...
                        <table class="table table-bordered text-center mb-0">
                            ...
                            <tbody class="align-middle">
                                @foreach ($products as $key => $item)
                                    ...
                                    @endphp
                                    <tr>
                                        <td class="align-middle"><img src="{{ $item->hinhanhproduct }}" width="100"></td>
                                        <td class="align-middle"><img src="img/product-1.jpg" alt=""
                                                style="width: 50px;">
                                            {{ $item->nameproduct }}</td>
                                        <td class="align-middle">{{ number_format($price) }}</td>
                                        <td class="align-middle">
                                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $carts[$item->id] }}" name="num_product[{{ $item->id }}]">
                                                <div class="input-group-btn">
